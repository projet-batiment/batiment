...
public class TypeOuvertureMurPane extends SidePane {
	TypeOuvertureMur typeOuvertureMur;
	Config config;

	private class TypeOuvertureMurEditor extends NameDescEditor {
		public TypeOuvertureMurEditor(Config config) {
	...
	public final void update() {
		TypeOuvertureMurEditor editThis = new TypeOuvertureMurEditor(config);
		editThis.initialize();
		super.addTab(editThis);
	}

	public TypeOuvertureMurPane(Config config, TypeOuvertureMur typeOuvertureMur) {
		this.config = config;
