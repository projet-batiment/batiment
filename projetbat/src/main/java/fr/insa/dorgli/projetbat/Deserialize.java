...
public class Deserialize {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TypeRevetement> typeRevetements = new ArrayList<TypeRevetement>();
        for (String line: buf) {
        ...
        ArrayList<TypeOuvertureMur> typeOuvertureMurs = new ArrayList<TypeOuvertureMur>();
        for (String line: buf) {
        ...
        ArrayList<TypeMur> typeMurs = new ArrayList<TypeMur>();
        for (String line: buf) {
        ...
        for (String line: buf) {
            if (line.matches("[0-9]+,[0-9]+,[0-9]+(\\.[0-9]+)?,[0-9]+")){
                try {
                    ...
                    ArrayList<String> buf_mur = new ArrayList<String>();
                    ...
                    ArrayList<RevetementMur> rev1 = new ArrayList<RevetementMur>();
                    ...
                    ArrayList<RevetementMur> rev2 = new ArrayList<RevetementMur>();
                    ...
                    ArrayList<OuvertureMur> ouv = new ArrayList<OuvertureMur>();
